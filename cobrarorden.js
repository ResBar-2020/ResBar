new Vue({
    ...
    methods: {
        ...
        createResumenDeVentas() {
            let efectivo = document.getElementById("lblEfectivo").value;
            let cambio = efectivo - this.ordenSelected.total - this.propina - this.domicilio;
        ...
        updateResumenDeVentas() {
            ...
            let totalAlert = this.ordenSelected.total + parseFloat(this.propina) + parseFloat(this.domicilio);
        ...
        cobrar: function() {
            ...
            if (propina != '') {
                totalEfectivo = this.ordenSelected.total + parseFloat(propina) + parseFloat(this.domicilio)
            } else {
